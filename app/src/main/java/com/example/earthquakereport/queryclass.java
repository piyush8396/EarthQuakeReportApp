    ...
    private static String readFromStream(InputStream inputStream) throws IOException {
        ...
        private static ArrayList<EarthQuake> extractFeatureFromJson(String earthquakeJSON) {
            ...
            try{
              ...
              JSONArray featureArray=rootobject.optJSONArray("features");
              for(int i=0;i<featureArray.length();i++)
              {
                 JSONObject obj=featureArray.getJSONObject(i);
                 JSONObject propobj=obj.optJSONObject("properties");
                 double magnitude=(propobj.optDouble("mag"));
                 String place=propobj.optString("place");
                 long date=propobj.getLong("time");
